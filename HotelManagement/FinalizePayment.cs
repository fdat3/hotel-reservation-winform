...
namespace Hotel_Manager
{
    public partial class FinalizePayment : MetroForm
    {
        ...
        private void FinalizePayment_Load(object sender, EventArgs e)
        {
            ...
            currentBillAmount.Text = Convert.ToString(totalAmountFromFrontend)+" VND";
            foodBillAmount.Text = Convert.ToString(foodBill) + " VND";
            taxAmount.Text = Convert.ToString(totalWithTax)+" VND";
            totalAmount.Text = Convert.ToString(FinalTotal) + " VND";
