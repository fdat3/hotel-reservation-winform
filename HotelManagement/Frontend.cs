...
namespace Hotel_Manager
{
    public partial class Frontend : MetroForm
    {
        public Frontend()
        {
            InitializeComponent();
            CenterToScreen();
            entryDatePicker.MinDate = DateTime.Now;
        ...
        public void foodMenuButton_Click(object sender, EventArgs e)
        {
            ...
            cleaning = food_menu.Cleaning.Replace(" ", string.Empty) == "Dọnphòng" ? "1" : "0";
            towel = food_menu.Towel.Replace(" ", string.Empty) == "Vòisen" ? "1" : "0";

            surprise = food_menu.Surprise.Replace(" ", string.Empty) == "Rượu" ? "1" : "0";

            if (breakfast > 0 || lunch > 0 || dinner > 0)
            {
                int bfast = 200000 * breakfast;
                int Lnch = 300000 * lunch;
                int di_ner = 50000 * dinner;
        ...
        private void roomTypeComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (roomTypeComboBox.SelectedItem.Equals("Phòng Đơn"))
            {
                totalAmount = 100000;
                floorComboBox.SelectedItem = "1";
            }
            else if (roomTypeComboBox.SelectedItem.Equals("Phòng Đôi"))
            {
                totalAmount = 300000;
                floorComboBox.SelectedItem = "2";
            }
            else if (roomTypeComboBox.SelectedItem.Equals("Phòng 2 giường"))
            {
                totalAmount = 400000;
                floorComboBox.SelectedItem = "3";
            }
            else if (roomTypeComboBox.SelectedItem.Equals("Phòng 2 tầng"))
            {
                totalAmount = 500000;
                floorComboBox.SelectedItem = "4";
            }
            else if (roomTypeComboBox.SelectedItem.Equals("Phòng hạng Suite"))
            {
                totalAmount = 700000;
            ...
            if (!temp)
            {
                MetroFramework.MetroMessageBox.Show(this, "Có lỗi", "LỖI", MessageBoxButtons.OK);
            }
            else
            {
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MetroFramework.MetroMessageBox.Show(this, "Đặt phòng thành công" + "\n\n" +
                "Mã người dùng: " + userID, "THÀNH CÔNG", MessageBoxButtons.OK, MessageBoxIcon.Question);
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            if (primartyID > 1000)
            {
                ...
                try
                {
                    ...
                    MetroFramework.MetroMessageBox.Show(this, "Xóa thành công phòng: " + "\n\n" +
                " " + primartyID, "XÓA THÀNH CÔNG", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
          SqlConnection connection = new SqlConnection(Hotel_Manager.Properties.Settings.Default.frontend_reservationConnectionString);
            ...
            else
            {
                ...
                SearchError.Text = "Không tìm thấy thông tin người dùng " + searchTextBox.Text; 
            }
        }
