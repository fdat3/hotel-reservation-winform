...
namespace Hotel_Manager
{
    public partial class Kitchen : MetroForm
    {
        ...
        private void dinnerTextBox_Click(object sender, EventArgs e)
        {
            ...
            if (connection.State != ConnectionState.Open)
            {
                ...
                if (primaryID > 1000)
                {
                    ...
                    try
                    {
                        ...
                        MetroFramework.MetroMessageBox.Show(this, "Đơn của khách: " + "\n\n" +
                        " " + userID + " đã thực hiện xong!", "THÀNH CÔNG", MessageBoxButtons.OK, MessageBoxIcon.Question);
